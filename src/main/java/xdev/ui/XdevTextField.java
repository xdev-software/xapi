...
public class XdevTextField extends JTextField implements ClientProperties, TextComponent,
		FormularComponent<XdevTextField>, XdevFocusCycleComponent
{
	...
	private static final XdevLogger								log					= LoggerFactory
																							.getLogger(XdevTextField.class);
	
	private final TextFormularComponentSupport<XdevTextField>	support				= new TextFormularComponentSupport(
																							this);
		...
		addFocusListener(new FocusListener()
		{
			public void focusGained(FocusEvent e)
			{
				SwingUtilities.invokeLater(new Runnable()
				{
					...
					public void run()
					{
						focusGainedBehavior.focusGained(XdevTextField.this);
					}
				});
			}
