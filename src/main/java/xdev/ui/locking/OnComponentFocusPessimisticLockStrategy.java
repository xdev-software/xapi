...
/**
 * On-Focus implementation of {@link PessimisticLockStrategy}.
 * <p>
 ...
 * @since 4.0
 */
public class OnComponentFocusPessimisticLockStrategy implements PessimisticLockStrategy
{
	...
	public OnComponentFocusPessimisticLockStrategy(Component cpn)
	{
		this.cpn = cpn;
	}
	...
	{
		FocusListener rowSpecificFocusListener = new OnComponentFocusLockStrategyFocusListener(
	 ...
	 */
	public OnComponentFocusPessimisticLockStrategy()
	{
	}
}
