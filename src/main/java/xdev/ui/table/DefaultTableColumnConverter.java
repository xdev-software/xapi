...
/**
 * Default implementation of {@link TableColumnConverter}.
 * <p>
 ...
 * @since 3.2
 */
public class DefaultTableColumnConverter implements TableColumnConverter
{
	...
	{
		return table.convertColumnIndexToView(column);
	}
}
