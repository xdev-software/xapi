 ...
 * @author Thomas Muenz
 */
public class SQLEngineUniqueConstraintInsertViolationException extends SQLEngineException {
	 ...
	 */
	public SQLEngineUniqueConstraintInsertViolationException(final SQLException originalException) {
