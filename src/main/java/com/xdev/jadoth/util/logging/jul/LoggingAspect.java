...
public class LoggingAspect 
{
	...
	public void logA(final String message, final Object... parameters){
		final String sourceClassName = this.sourceClassName!=null?this.sourceClassName:this.determineSourceClassName();
	...
	public void logC(final String message, final Class<?> sourceClass, final Object... parameters){
		this.logger.logp(this.defaultLevel, sourceClass==null?null:sourceClass.getName(), null, message, parameters);
	}
	 ...
	 * @param parameters the parameters
	 */
	public void logB(final Level level, final String message, final Class<?> sourceClass, final String methodName, final Object... parameters){
	 ...
	 * @param thrown the thrown
	 */
	public void logB(final Level level, final String message, final Class<?> sourceClass,  final String methodName, final Throwable thrown){
